...
bank。波形、音色、参数等数据无损保留，stock 28 输出 PCM 仍要求逐样本、逐 bit 一致。
...
阶段交付和首个完整算法样板。按此实施，旧 07–11 用作证据，不直接照其 L0 草案施工。
...
mk2cpp/
  ...
  docs/                00–02 计划/架构/约定；03–11 旧研究；12 复评；13 目标；14 架构；15 施工规程
